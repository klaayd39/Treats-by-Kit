...
export default function Menu({ category, items, onOpen, onAdd }) {
  ...
  return (
    <section className="px-5 pb-28 pt-8 sm:px-8 sm:pt-10 lg:px-12 lg:pt-12 landscape:min-[1024px]:pb-20">
      <div className="mb-10 text-center sm:mb-14">
        <p className="font-script text-3xl text-blue sm:text-4xl">Treats by Kit</p>
        <h1 className="mt-1 font-serif text-5xl font-medium leading-none text-blue-deep sm:text-6xl lg:text-7xl">
          {current.title}
        </h1>
